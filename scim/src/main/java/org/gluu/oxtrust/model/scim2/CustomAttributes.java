 ...
 * {@link Double}, for <code>boolean</code> use {@link Boolean}, and for <code>date</code> you may use {@link Date}
 * or {@link DateTime} from Joda-Time library.</p>
...
public class CustomAttributes {
    ...
    /**
     * Sets the value of an attribute using a Joda <code>DateTime</code>.
     * @param name Name of attribute
    ...
    /**
     * Sets the value of an attribute using a JDK <code>Date</code>.
     * @param name Name of attribute
     * @param value A Date object. Must be non-null, or else it won't be stored
     */
    public void setAttribute(String name, Date value){
        if (value!=null)
            setAttribute(name, ISODateTimeFormat.dateTime().print(new DateTime(value)));
    }
        ...
        if (val!=null) {
            ...
            if (val!=null) {
                if (DateTime.class.equals(cls) || Date.class.equals(cls)) {
                    try{
                        val=new DateTime(val.toString());
                        if (Date.class.equals(cls))
                            val=((DateTime)val).toDate();
                    }
                    catch (Exception e){
                        val = null;
                    }
