 ...
 *
 * Shared interface of SCIM service methods to manipulate Group resources.
...
public interface IGroupWebService {
     ...
     * @param group An object that represents the Group to create
     ...
     * A succesful response for this operation should contain a status code of 201 (created) and a {@link GroupResource}
     ...
     * @param excludedAttrsList See notes about <a href="#attrsList">excludedAttributes</a> query param
     * @return An object abstracting the response obtained from the server to this request.
     * A succesful response for this operation should contain a status code of 200 and a {@link GroupResource}
     ...
     * @param group An object that contains the data to update on a destination resource. There is no need to supply a full
     *              resource, just provide one with the attributes which are intended to be replaced in the destination
     *              including the attributes marked as required in the resource schema
     ...
     * @param excludedAttrsList See notes about <a href="#attrsList">excludedAttributes</a> query param
     * @return An object abstracting the response obtained from the server to this request.
     * A succesful response for this operation should contain a status code of 200 and a {@link org.gluu.oxtrust.model.scim2.ListResponse
     ...
     *                      {@link #searchGroups(String, Integer, Integer, String, String, String, String) searchDevices}
     * @return An object abstracting the response obtained from the server to this request.
