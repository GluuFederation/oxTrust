...
public interface IFidoDeviceWebService {
     ...
     * @param fidoDeviceResource An object that contains the data to update on a destination resource. There is no need to
     *                           supply a full resource, just provide one with the attributes which are intended to be
