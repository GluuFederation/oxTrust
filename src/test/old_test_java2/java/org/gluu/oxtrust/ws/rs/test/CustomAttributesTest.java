...
/**
 * SCIM UserWebService - custom attributes tests 
 *
 * @author Reda Zerrad Date: 07.27.2012
 */
public class CustomAttributesTest extends ConfigurableTest {
    ...
    public void getUserByUidXml() throws Exception {
        new ResourceRequest(new ResourceRequestEnvironment(this), Method.GET, "/restv1/Users/" + inum) {
            ...
            protected void onResponse(EnhancedMockHttpServletResponse response) {
                ...
                assertEquals("some random value1", person.getCustomAttributes().get(0).getValues().get(0),"custom attributes arent the same");
                assertEquals("some random value2", person.getCustomAttributes().get(0).getValues().get(1),"custom attributes arent the same");
            }
        }.run();
    }
...
//				showResponse("requestTest", response);
                ...
                assertEquals("some random value1111", person.getCustomAttributes().get(0).getValues().get(0),"custom attributes arent the same");
                assertEquals("some random value2222", person.getCustomAttributes().get(0).getValues().get(1),"custom attributes arent the same");
            }
        }.run();
    }
