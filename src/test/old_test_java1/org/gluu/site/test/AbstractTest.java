...
import org.gluu.site.util.security.PropertiesDecrypter;
...
public class AbstractTest {
	...
	protected static void setSuperBeforeClass() throws Exception {
		...
		connectionProvider = new LDAPConnectionProvider(PropertiesDecrypter.decryptProperties(localConfiguration.getProperties()));
