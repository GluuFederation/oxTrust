 ...
 */
@Path(OxTrustApiConstants.BASE_API_URL + OxTrustApiConstants.TRUSTS)
@Consumes(MediaType.APPLICATION_JSON)
@Produces(MediaType.APPLICATION_JSON)
@Api(value = OxTrustApiConstants.BASE_API_URL
		+ OxTrustApiConstants.TRUSTS, description = "Trust relationship web service", authorizations = {
...
@ApplicationScoped
public class TrustRelationshipWebResource extends BaseWebResource {
	...
	public TrustRelationshipWebResource() {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK", response = GluuSAMLTrustRelationship.class),
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK"),
			@ApiResponse(code = 500, message = "Server error") })
	public void update(@PathParam("inum") @NotNull String inum, GluuSAMLTrustRelationship trustRelationship,
	...
	@GET
	@ApiOperation(value = "List all trusts", notes = "List all trusts", response = SAMLTrustRelationshipShort[].class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK", response = GluuSAMLTrustRelationship.class),
			@ApiResponse(code = 500, message = "Server error") })
	public Response getAllTrusts() {
		try {
			List<SAMLTrustRelationshipShort> trusts = convertTRtoTRShort(trustService.getAllTrustRelationships());
			return Response.ok(trusts).build();
		} catch (Exception e) {
			log(logger, e);
	...
	@GET
	@Path(OxTrustApiConstants.FEDERATIONS)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK", response = SAMLTrustRelationshipShort.class),
			@ApiResponse(code = 500, message = "Server error") })
	public Response listAllFederations(@Context HttpServletResponse response) {
		try {
			List<SAMLTrustRelationshipShort> federations = convertTRtoTRShort(trustService.getAllFederations());
			return Response.ok(federations).build();
		} catch (Exception e) {
			log(logger, e);
			return Response.status(Response.Status.INTERNAL_SERVER_ERROR).build();
		}
	...
	public String listAllOtherFederations(@PathParam("inum") String inum, @Context HttpServletResponse response) {
		try {
			List<SAMLTrustRelationshipShort> trustRelationships = convertTRtoTRShort(
					trustService.getAllOtherFederations(inum));
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK", response = SAMLTrustRelationshipShort.class),
			@ApiResponse(code = 500, message = "Server error") })
	public String listAllSAMLTrustRelationships(@QueryParam("size_limit") int sizeLimit,
			@Context HttpServletResponse response) {
		try {
			List<SAMLTrustRelationshipShort> trustRelationships = convertTRtoTRShort(
					trustService.getAllSAMLTrustRelationships(sizeLimit));
			return objectMapper.writeValueAsString(trustRelationships);
		} catch (Exception e) {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK", response = SAMLTrustRelationshipShort.class),
			@ApiResponse(code = 500, message = "Server error") })
	public String listDeconstructedTrustRelationships(@PathParam("inum") String inum,
			@Context HttpServletResponse response) {
		try {
			GluuSAMLTrustRelationship trustRelationship = trustService.getRelationshipByInum(inum);
			List<SAMLTrustRelationshipShort> trustRelationships = convertTRtoTRShort(
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK", response = SAMLTrustRelationshipShort.class),
			@ApiResponse(code = 500, message = "Server error") })
	public Response searchTrustRelationships(@QueryParam("pattern") @NotNull String pattern,
			@QueryParam("size_limit") int sizeLimit) {
		try {
			List<SAMLTrustRelationshipShort> trustRelationships = convertTRtoTRShort(
					trustService.searchSAMLTrustRelationships(pattern, sizeLimit));
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK"),
			@ApiResponse(code = 500, message = "Server error") })
	public void setMetadata(@PathParam("inum") String trustRelationshipInum, @NotNull String metadata,
			@Context HttpServletResponse response) {
		try {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK"),
			@ApiResponse(code = 500, message = "Server error") })
	public void setMetadataURL(@PathParam("inum") String trustRelationshipInum, @NotNull String url,
			@Context HttpServletResponse response) {
		try {
			GluuSAMLTrustRelationship trustRelationship = trustService.getRelationshipByInum(trustRelationshipInum);
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK"),
			@ApiResponse(code = 500, message = "Server error") })
	public void addAttribute(@PathParam("inum") String trustRelationshipInum, @NotNull String attribute,
			@Context HttpServletResponse response) {
		try {
			GluuSAMLTrustRelationship trustRelationship = trustService.getRelationshipByInum(trustRelationshipInum);
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK"),
			@ApiResponse(code = 500, message = "Server error") })
	public void setContacts(@PathParam("inum") String trustRelationshipInum, String contacts,
			@Context HttpServletResponse response) {
		try {
			GluuSAMLTrustRelationship trustRelationship = trustService.getRelationshipByInum(trustRelationshipInum);
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK"),
			@ApiResponse(code = 500, message = "Server error") })
	public void setCertificate(@PathParam("inum") String trustRelationshipInum, String certificate,
			@Context HttpServletResponse response) {
		try {
			GluuSAMLTrustRelationship trustRelationship = trustService.getRelationshipByInum(trustRelationshipInum);
	 ...
	 * @param metadata
	 *            - need for FILE type TR only
	 * @param certificate
	 *            - need for FILE type TR, optional for GENERATE type TR
	 * @return
	 */
		...
		synchronized (svnSyncTimer) {
			...
			case FILE:
				try {
					...
					// facesMessages.add(FacesMessage.SEVERITY_ERROR, "Failed to download SP
					// metadata");
			...
			case URI:
				try {
					...
					// facesMessages.add(FacesMessage.SEVERITY_ERROR, "Unable to download
					// metadata");
			...
			case FEDERATION:
				...
				if (trustRelationship.getEntityId() == null) {
					// facesMessages.add(FacesMessage.SEVERITY_ERROR, "EntityID must be set to a
					// value");
	...
	private boolean saveSpMetaDataFileSourceTypeFile(GluuSAMLTrustRelationship trustRelationship, String inum,
		...
		String result = shibboleth3ConfService.saveSpMetadataFile(spMetadataFileName,
				new CharSequenceInputStream(metadata, StandardCharsets.UTF_8));
		if (StringHelper.isNotEmpty(result)) {
			metadataValidationTimer.queue(result);
		} else {
			// facesMessages.add(FacesMessage.SEVERITY_ERROR, "Failed to save SP meta-data
			// file. Please check if you provide correct file");
		}
	...
	public String generateCertForGeneratedSP(GluuSAMLTrustRelationship trustRelationship) throws IOException {
		...
		// facesMessages.add(FacesMessage.SEVERITY_ERROR, "Certificate were not
		// provided, or was incorrect. Appliance will create a self-signed
		// certificate.");
		...
		if (cert != null) {
			...
			try {
				...
				certificate = null;
				// facesMessages.add(FacesMessage.SEVERITY_ERROR, "Failed to encode provided
				// certificate. Please notify Gluu support about this.");
	...
	private void updateTRCertificate(GluuSAMLTrustRelationship trustRelationship, String certificate)
			throws IOException {
		if (StringHelper.isEmpty(certificate)) {
			logger.error("Failed to update TR certificate - certificate is empty");
			return;
	...
	private static List<SAMLTrustRelationshipShort> convertTRtoTRShort(
