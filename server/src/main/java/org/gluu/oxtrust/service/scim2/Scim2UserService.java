...
public class Scim2UserService implements Serializable {
    ...
    private void transferAttributesToPerson(UserResource res, GluuCustomPerson person) {
        ...
        //TODO: custom attributes in extension
    }

    private void transferAttributesToUserResource(GluuCustomPerson person, UserResource res) {
        ...
        Meta meta=new Meta();
        meta.setResourceType(ResourceType.getType(res.getClass()));
    ...
    public Pair<GluuCustomPerson, UserResource> updateUser(String id, UserResource user) throws Exception {
        ...
        if (gluuPerson!=null){
            ...
            tmpUser=(UserResource) ScimResourceUtil.transferToResource(user, tmpUser);
