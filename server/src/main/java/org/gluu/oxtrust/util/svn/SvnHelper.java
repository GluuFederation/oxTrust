...
public final class SvnHelper {
	...
	public static SVNCommitInfo importDirectory(SVNClientManager clientManager, File localPath, SVNURL dstURL, String commitMessage,
		 ...
		 * committed (revision number, etc.)
		 */
		return clientManager.getCommitClient().doImport(localPath, dstURL, commitMessage, null, true, false,
	...
	public static SVNCommitInfo commit(SVNClientManager clientManager, File wcPath, boolean keepLocks, String commitMessage)
		 ...
		 * committed (revision number, etc.)
		 */
		return clientManager.getCommitClient().doCommit(new File[] { wcPath }, keepLocks, commitMessage, null, null, false, false,
				SVNDepth.INFINITY);
	}
	 ...
	 */
	public static void add(SVNClientManager clientManager, File wcPath) throws SVNException {
		clientManager.getWCClient().doAdd(wcPath, false, false, false, SVNDepth.INFINITY, false, false);
	}
	 ...
	 */
	public static void lock(SVNClientManager clientManager, File wcPath, boolean isStealLock, String lockComment) throws SVNException {
	 ...
	 */
	public static void delete(SVNClientManager clientManager, File wcPath, boolean force) throws SVNException {
	...
	public static SVNRepository getSVNRepository(SVNClientManager svnClientManager, SVNURL repositoryURL) throws SVNException {
		return svnClientManager.createRepository(repositoryURL, false);
	}
	...
	public static void addNewFiles(final SVNClientManager clientManager, File dir) throws SVNException {
		clientManager.getWCClient().doAdd(dir, true, false, false, SVNDepth.INFINITY, false, false);
	}
