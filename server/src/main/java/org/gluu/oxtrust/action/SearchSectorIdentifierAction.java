	...
	public String search() {
		...
		try {
			if (searchPattern == null || searchPattern.isEmpty()) {
				...
				this.sectorIdentifierList = sectorIdentifierService.searchSectorIdentifiers(this.searchPattern,
						OxTrustConstants.searchSectorIdentifierSizeLimit);
			}
			this.sectorIdentifierList.sort(Comparator.comparing(OxAuthSectorIdentifier::getDescription));
